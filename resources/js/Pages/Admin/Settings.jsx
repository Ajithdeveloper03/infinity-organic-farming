        ...
        <AdminLayout>
            <div className="max-w-4xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                    ...
                    <button 
                        onClick={handleSave}
                        className="cursor-pointer bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white px-5 py-2.5 rounded-xl font-bold flex items-center transition-all shadow-md shadow-green-500/20"
                    >
                ...
                <div className="space-y-6">
                    ...
                    <div className="cursor-pointer bg-white border border-gray-100 rounded-[2rem] p-8 shadow-sm hover:shadow-md transition-shadow group">
                        <h2 className="text-xl font-heading font-bold text-gray-900 flex items-center mb-6 group-hover:text-green-600 transition-colors">
                            <div className="p-2 bg-green-50 border border-green-100 rounded-xl mr-3 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="cursor-pointer group/input">
                                <label className="cursor-pointer block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-2 group-hover/input:text-green-600 transition-colors">Check-in Buffer Radius (Meters)</label>
                            ...
                            <div className="cursor-pointer group/input">
                                <label className="cursor-pointer block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-2 group-hover/input:text-green-600 transition-colors">Stationary Alert Timeout (Minutes)</label>
                    ...
                    <div className="cursor-pointer bg-white border border-gray-100 rounded-[2rem] p-8 shadow-sm hover:shadow-md transition-shadow group">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between bg-gray-50 border border-gray-100 p-5 rounded-2xl shadow-sm hover:border-orange-200 transition-colors gap-4">
                            ...
                            <div className="flex items-center space-x-4">
                                <input type="time" defaultValue="08:30" className="cursor-pointer bg-white border border-gray-200 rounded-lg font-bold text-gray-700 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-shadow shadow-sm hover:border-orange-300" />
