...
export default function EmployeeDetail({ id }) {
    ...
    const emp = {
        ...
        phone: '+91 9876543210',
        joined: 'Jan 2025',
        img: 'https://ui-avatars.com/api/?name=User&background=f97316&color=fff?auto=format&fit=crop&q=80&w=300&h=300'
    };
    ...
    const mapContent = (
        <div className={`bg-white overflow-hidden flex flex-col cursor-pointer group transition-all duration-300 ${isMapFullscreen ? 'fixed top-0 left-0 right-0 bottom-0 z-[99999] w-[100vw] h-[100vh] m-0 p-0 border-0 rounded-none' : 'rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-md h-[700px] relative'}`}>
            ...
            <div className="p-5 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white flex justify-between items-center z-10 relative">
                <div>
                ...
                <div className="flex items-center space-x-4">
                    <span className="bg-green-50 text-green-600 text-[10px] font-bold px-3 py-1.5 rounded-md border border-green-100 flex items-center uppercase tracking-wider">
                        <span className="w-2 h-2 rounded-full bg-green-500 animate-ping mr-2"></span> Tracking Active
                    </span>
                    <button 
                        onClick={(e) => {
                            e.stopPropagation();
                        ...
                        className="p-2 bg-white border border-gray-200 rounded-xl shadow-sm hover:text-green-600 hover:border-green-300 transition-colors z-50"
                    >
            ...
            <div className="flex-1 relative bg-gray-50 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] flex items-center justify-center overflow-hidden">
                ...
                <div className="z-10 flex flex-col items-center">
                    <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-md border-4 border-green-200 relative animate-bounce">
                        ...
                        <div className="absolute -bottom-2 -right-2 bg-gradient-to-r from-emerald-600 to-teal-600 w-6 h-6 rounded-full border-2 border-white flex items-center justify-center shadow-sm">
    ...
    return (
        <AdminLayout>
            <div className="mb-6">
                <Link href="/admin/employees" className="cursor-pointer inline-flex items-center text-sm font-bold text-gray-500 hover:text-green-600 transition-colors">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className={`col-span-1 space-y-8 ${isMapFullscreen ? 'hidden' : 'block'}`}>
                    <div className="bg-white border border-gray-100 rounded-[2rem] p-8 shadow-sm text-center relative overflow-hidden group hover:shadow-md transition-shadow">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-green-50 to-transparent rounded-bl-full -mr-8 -mt-8 pointer-events-none"></div>
                        ...
                        <p className="text-[10px] font-mono font-bold text-green-500 mt-1 bg-green-50 px-2 py-0.5 rounded-lg inline-block">{emp.id}</p>
                        
                        <div className="mt-6 flex flex-col space-y-3 text-left bg-gray-50 p-5 rounded-2xl border border-gray-100">
                            <div className="flex items-center text-sm font-medium text-gray-700">
                                <ShieldCheck className="w-4 h-4 text-orange-500 mr-3" /> {emp.role}
                            </div>
                            <div className="flex items-center text-sm font-medium text-gray-700">
                                <MapPin className="w-4 h-4 text-green-500 mr-3" /> {emp.region}
                            </div>
                            <div className="flex items-center text-sm font-medium text-gray-700">
                    ...
                    <div className="bg-white border border-gray-100 rounded-[2rem] p-6 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center cursor-pointer hover:bg-gray-50 p-2 rounded-xl transition-colors">
                                <span className="text-sm font-medium text-gray-600 flex items-center"><Navigation className="w-4 h-4 mr-2 text-green-500" /> Distance</span>
                                <span className="font-heading font-bold text-gray-900">42.5 km</span>
                            </div>
                            <div className="flex justify-between items-center cursor-pointer hover:bg-gray-50 p-2 rounded-xl transition-colors">
                                <span className="text-sm font-medium text-gray-600 flex items-center"><Clock className="w-4 h-4 mr-2 text-orange-500" /> Hours Logged</span>
