  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      <View className="px-6 pt-12 pb-4 bg-white flex-row items-center border-b border-gray-100">
        ...
        <Text className="text-gray-900 text-lg font-gotham-bold">Visit Report</Text>
      </View>
        ...
        <View className="px-6 -mt-8">
           ...
           <View className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-6">
              <View className="flex-row justify-between items-start mb-6 pb-6 border-b border-gray-100">
                 <View>
                   <Text className="text-gray-900 font-gotham-bold text-lg">Visit by Arun Kumar</Text>
                 ...
                 <View className="bg-green-50 px-3 py-1.5 rounded-full">
                   <Text className="text-[#15803d] font-gotham-bold text-xs">Completed</Text>
                 </View>
              </View>
              ...
              <View className="mb-6">
                 <View className="flex-row items-center mb-2">
                    ...
                    <Text className="text-gray-900 font-gotham-bold ml-2">Crop Condition</Text>
                 </View>
              ...
              <View className="mb-6">
                 <View className="flex-row items-center mb-2">
                    <CheckCircle2 size={16} color="#15803d" />
                    <Text className="text-gray-900 font-gotham-bold ml-2">Notes</Text>
                 </View>
              ...
              <View className="mb-6">
                 <Text className="text-gray-900 font-gotham-bold mb-3">Photos</Text>
