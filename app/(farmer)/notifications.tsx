...
const notifications = [
  { id: '1', title: 'Upcoming Visit Reminder', desc: 'Arun Kumar will visit your farm on May 28, 2025.', time: '15m ago', icon: Calendar, color: '#e87111', bg: 'bg-orange-50' },
    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      <View className="px-6 pt-12 pb-4 bg-white flex-row items-center justify-between border-b border-gray-100">
        <View className="flex-row items-center">
           ...
           <Text className="text-gray-900 text-lg font-bold">Notifications</Text>
        </View>
        <TouchableOpacity>
           <Text className="text-[#15803d] font-bold text-sm">Clear All</Text>
        </TouchableOpacity>
      </View>
      ...
      <ScrollView className="flex-1 pb-24">
        <View className="px-6 pt-6">
               ...
               <View key={notif.id} className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 mb-4 flex-row">
                  ...
                  <View className="flex-1">
                     <View className="flex-row justify-between items-start mb-1">
                        <Text className="text-gray-900 font-bold text-base flex-1 pr-2">{notif.title}</Text>
           ...
           <TouchableOpacity className="bg-gray-100 py-4 rounded-xl items-center mt-4">
              <Text className="text-gray-600 font-bold">Mark all as read</Text>
           </TouchableOpacity>
