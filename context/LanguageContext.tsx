...
export const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    registeredFarmDetails: "Registered Farm Details",
    farmName: "Farm Name",
    village: "Village",
    district: "District",
    soilType: "Soil Type",
    totalArea: "Total Area",
    verifiedOrganicLand: "Verified Organic Land",
    ...
    ifscCode: "IFSC Code",
    branch: "Branch",
    farmingAgreement: "Farming Agreement",
    landDocument: "Land Document & Survey",
    aadhaarCard: "Aadhaar Card (Verified)",
    ...
    referralDesc: "Invite neighboring farmers and get bonus reward points!",
  },
  ...
  ta: {
    ...
    registeredFarmDetails: "பதிவுசெய்த பண்ணை விவரங்கள்",
    farmName: "பண்ணை பெயர்",
    village: "கிராமம்",
    district: "மாவட்டம்",
    soilType: "மண் வகை",
    totalArea: "மொத்த பரப்பளவு",
    verifiedOrganicLand: "சான்றளிக்கப்பட்ட இயற்கை நிலம்",
    ...
    branch: "வங்கி கிளை",
    farmingAgreement: "விவசாய ஒப்பந்தம்",
    landDocument: "நில ஆவணம் & சர்வே",
    aadhaarCard: "ஆதார் அட்டை (சரிபார்க்கப்பட்டது)",
    bankDetails: "வங்கி கணக்கு விவரங்கள்",
    uploadDoc: "ஆவணம் பதிவேற்றுக",
    ...
    visitReports: "வருகை அறிக்கைகள்",
    supportFaq: "உதவி & கேள்விகள்",
    feedback: "கருத்துக்கள்",
    referEarn: "பரிந்துரைத்து பரிசு வெல்க",
    shareInvite: "பகிர்க",
    referralDesc: "அண்டை விவசாயிகளை இணைத்து பரிசுகளைப் பெறுங்கள்!",
  },
};
